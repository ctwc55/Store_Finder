...
void setStoreInfo(Node store[]) {
	...
	//정점
	//200경영관 201중앙도서관  202쪽문엘리베이터  
	//203학교정문  204혜화역4번출구(대명거리213)  
	//205올레사거리  206혜화역1번출구(< -215)
	...
	strcpy(store[216].name, "600주년기념관");
	store[216].price = 0;
	store[216].type = 4;
